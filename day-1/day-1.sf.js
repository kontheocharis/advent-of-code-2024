...
const cell = (value) => io_effect(() => ({ value }));
...
var parse_natM = (s0) => (() => {
  var subject1 = (parse_nat)(s0);
  return (() => {
    switch ((subject1)[0]) {
      case "nothing": return (THROW)((string_concat)("Invalid input: ")(s0));
      case "just": return ((n1) => (io_return)(n1))((subject1)[1]);
    }
  })();
})();
